    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumos_claro', to='partes.Parte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado', models.DateTimeField(auto_now_add=True)),
                ('actualizado', models.DateTimeField(auto_now=True)),
                ('parte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumos_nokia', to='partes.Parte')),
            ],
            options={
