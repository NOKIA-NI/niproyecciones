...
class Existencia(models.Model):
    ...
    def calculate_existencia(sender, instance, **kwargs):
        try:
            if instance.parte.resultado and instance.parte.existencia:
                ...
                if existencia_w14 != instance.parte.existencia.w14 and WEEK < 14:
                    instance.parte.existencia.w14 = existencia_w14
                if existencia_w15 != instance.parte.existencia.w15 and WEEK < 15:
                    instance.parte.existencia.w15 = existencia_w15
                if existencia_w16 != instance.parte.existencia.w16 and WEEK < 16:
                    instance.parte.existencia.w16 = existencia_w16
                if existencia_w17 != instance.parte.existencia.w17 and WEEK < 17:
                    instance.parte.existencia.w17 = existencia_w17
                if existencia_w18 != instance.parte.existencia.w18 and WEEK < 18:
                    instance.parte.existencia.w18 = existencia_w18
                if existencia_w19 != instance.parte.existencia.w19 and WEEK < 19:
                    instance.parte.existencia.w19 = existencia_w19
                if existencia_w20 != instance.parte.existencia.w20 and WEEK < 20:
                    instance.parte.existencia.w20 = existencia_w20
                if existencia_w21 != instance.parte.existencia.w21 and WEEK < 21:
                    instance.parte.existencia.w21 = existencia_w21
                if existencia_w22 != instance.parte.existencia.w22 and WEEK < 22:
                    instance.parte.existencia.w22 = existencia_w22
                if existencia_w23 != instance.parte.existencia.w23 and WEEK < 23:
                    instance.parte.existencia.w23 = existencia_w23
                if existencia_w24 != instance.parte.existencia.w24 and WEEK < 24:
                    instance.parte.existencia.w24 = existencia_w24
                if existencia_w25 != instance.parte.existencia.w25 and WEEK < 25:
                    instance.parte.existencia.w25 = existencia_w25
                if existencia_w26 != instance.parte.existencia.w26 and WEEK < 26:
                    instance.parte.existencia.w26 = existencia_w26
                if existencia_w27 != instance.parte.existencia.w27 and WEEK < 27:
                    instance.parte.existencia.w27 = existencia_w27
                if existencia_w28 != instance.parte.existencia.w28 and WEEK < 28:
                    instance.parte.existencia.w28 = existencia_w28
                if existencia_w29 != instance.parte.existencia.w29 and WEEK < 29:
                    instance.parte.existencia.w29 = existencia_w29
                if existencia_w30 != instance.parte.existencia.w30 and WEEK < 30:
                    instance.parte.existencia.w30 = existencia_w30
                if existencia_w31 != instance.parte.existencia.w31 and WEEK < 31:
                    instance.parte.existencia.w31 = existencia_w31
                if existencia_w32 != instance.parte.existencia.w32 and WEEK < 32:
                    instance.parte.existencia.w32 = existencia_w32
                if existencia_w33 != instance.parte.existencia.w33 and WEEK < 33:
                    instance.parte.existencia.w33 = existencia_w33
                if existencia_w34 != instance.parte.existencia.w34 and WEEK < 34:
                    instance.parte.existencia.w34 = existencia_w34
                if existencia_w35 != instance.parte.existencia.w35 and WEEK < 35:
                    instance.parte.existencia.w35 = existencia_w35
                if existencia_w36 != instance.parte.existencia.w36 and WEEK < 36:
                    instance.parte.existencia.w36 = existencia_w36
                if existencia_w37 != instance.parte.existencia.w37 and WEEK < 37:
                    instance.parte.existencia.w37 = existencia_w37
                if existencia_w38 != instance.parte.existencia.w38 and WEEK < 38:
                    instance.parte.existencia.w38 = existencia_w38
                if existencia_w39 != instance.parte.existencia.w39 and WEEK < 39:
                    instance.parte.existencia.w39 = existencia_w39
                if existencia_w40 != instance.parte.existencia.w40 and WEEK < 40:
                    instance.parte.existencia.w40 = existencia_w40
                if existencia_w41 != instance.parte.existencia.w41 and WEEK < 41:
                    instance.parte.existencia.w41 = existencia_w41
                if existencia_w42 != instance.parte.existencia.w42 and WEEK < 42:
                    instance.parte.existencia.w42 = existencia_w42
                if existencia_w43 != instance.parte.existencia.w43 and WEEK < 43:
                    instance.parte.existencia.w43 = existencia_w43
                if existencia_w44 != instance.parte.existencia.w44 and WEEK < 44:
                    instance.parte.existencia.w44 = existencia_w44
                if existencia_w45 != instance.parte.existencia.w45 and WEEK < 45:
                    instance.parte.existencia.w45 = existencia_w45
                if existencia_w46 != instance.parte.existencia.w46 and WEEK < 46:
                    instance.parte.existencia.w46 = existencia_w46
                if existencia_w47 != instance.parte.existencia.w47 and WEEK < 47:
                    instance.parte.existencia.w47 = existencia_w47
                if existencia_w48 != instance.parte.existencia.w48 and WEEK < 48:
                    instance.parte.existencia.w48 = existencia_w48
                if existencia_w49 != instance.parte.existencia.w49 and WEEK < 49:
                    instance.parte.existencia.w49 = existencia_w49
                if existencia_w50 != instance.parte.existencia.w50 and WEEK < 50:
                    instance.parte.existencia.w50 = existencia_w50
                if existencia_w51 != instance.parte.existencia.w51 and WEEK < 51:
                    instance.parte.existencia.w51 = existencia_w51
                if existencia_w52 != instance.parte.existencia.w52 and WEEK < 52:
